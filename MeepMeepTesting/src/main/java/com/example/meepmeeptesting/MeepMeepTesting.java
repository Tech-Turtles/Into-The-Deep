...
public class MeepMeepTesting {
    ...
    private static double robotW = 17.8;
    private static double robotH = 16;
    private static double robotHalfW = robotH/2.0;
    public static void main(String[] args) {
        ...
        TrajectoryActionBuilder chamberToSpikeMark =
                myBot.getDrive().actionBuilder(new Pose2d(10, (-72 + robotHalfW), Math.toRadians(90)))
                        .splineTo(new Vector2d(0, (-24 - robotHalfW)), Math.toRadians(90)) //specimen place
        ...
        myBot.runAction(chamberToSpikeMark.build());
